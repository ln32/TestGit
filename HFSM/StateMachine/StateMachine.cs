...
namespace UnityHFSM
{
		...
		IActionable<TEvent>
	{
		...
		internal static readonly List<TransitionBase<TStateId>> noTransitions
			= new List<TransitionBase<TStateId>>(0);
        internal static readonly Dictionary<TEvent, List<TransitionBase<TStateId>>> noTriggerTransitions
        ...
        internal StateBase<TStateId> activeState = null;
		internal List<TransitionBase<TStateId>> activeTransitions = noTransitions;
        internal Dictionary<TEvent, List<TransitionBase<TStateId>>> activeTriggerTransitions = noTriggerTransitions;
